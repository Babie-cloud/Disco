...
export type WithT<Ns extends Namespace = DefaultNamespace> =
  i18nextMod.WithT<Ns>;
...
export type BackendModule<TOptions = object> =
  i18nextMod.BackendModule<TOptions>;
export type LanguageDetectorModule = i18nextMod.LanguageDetectorModule;
export type LanguageDetectorAsyncModule =
  i18nextMod.LanguageDetectorAsyncModule;
