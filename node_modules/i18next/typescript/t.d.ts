...
type AppendNamespace<Ns, Keys> =
  `${Ns & string}${_NsSeparator}${Keys & string}`;
 ...
 *********************************************************************** */
export type KeysByTOptions<TOpt extends TOptions> =
  TOpt["returnObjects"] extends true ? ResourceKeys<true> : ResourceKeys;

export type NsByTOptions<
...
> extends Branded<Ns> {
  ...
  >(
    ...
    TFunctionProcessReturnValue<$NoInfer<Ret>, never>,
    TOpt
  >;
  <
    const Key extends ParseKeys<Ns, TOpt, KPrefix> | TemplateStringsArray,
...
> extends Branded<Ns> {
  ...
  <
    Target extends ConstrainTarget<Opts>,
    const Opts extends SelectorOptions<Ns>,
  >(
...
type ConstrainTarget<Opts extends SelectorOptions<any>> =
  _ReturnObjects extends true
    ? unknown
