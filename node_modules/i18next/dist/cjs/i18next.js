...
class Translator extends EventEmitter {
  ...
  extractFromKey(key, opt) {
    let nsSeparator =
      opt.nsSeparator !== undefined
        ? opt.nsSeparator
        : this.options.nsSeparator;
    if (nsSeparator === undefined) nsSeparator = ":";
    const keySeparator =
      opt.keySeparator !== undefined
        ? opt.keySeparator
        : this.options.keySeparator;
  ...
  translate(keys, o, lastKey) {
    ...
    const joinArrays =
      opt.joinArrays !== undefined ? opt.joinArrays : this.options.joinArrays;
  ...
  resolve(keys, opt = {}) {
    ...
    keys.forEach((k) => {
      ...
      const needsPluralHandling =
        opt.count !== undefined && !isString(opt.count);
      const needsZeroSuffixLookup =
        needsPluralHandling && !opt.ordinal && opt.count === 0;
...
const createNonCachedFormatter = (fn) => (v, l, o) =>
